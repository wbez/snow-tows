...
View the [sample copy spreadsheet](https://docs.google.com/spreadsheet/pub?key=1sFqiNM4CQsPCv1pvCgwB280iC5-CP2_Ex1Nkyx1xXNk#gid=0).
...
def read_my_google_doc():
    ...
    get_document('1sFqiNM4CQsPCv1pvCgwB280iC5-CP2_Ex1Nkyx1xXNk', file_path)
    data = Copy(file_path)
...
```
* * * * * ubuntu bash /home/ubuntu/apps/snow_tows/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|snow-tows|tweet|`location`||
|snow-tows|facebook|`location`||
|snow-tows|email|`location`||
|snow-tows|new-comment||
|snow-tows|open-share-discuss||
|snow-tows|close-share-discuss||
|snow-tows|summary-copied||
|snow-tows|featured-tweet-action|`action`|
|snow-tows|featured-facebook-action|`action`|
